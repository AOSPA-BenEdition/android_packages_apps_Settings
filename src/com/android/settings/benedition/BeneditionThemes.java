...
import com.android.internal.util.benedition.ThemesUtils;
import com.android.internal.util.benedition.BeneditionUtils;
import com.android.settings.SettingsPreferenceFragment;
import com.android.settings.benedition.margaritov.preference.colorpicker.ColorPickerPreference;

public class BeneditionThemes extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.benedition_themes);
    ...
    private void setupThemeSwitchPref() {
        ...
        if (BeneditionUtils.isThemeEnabled("com.android.theme.materialocean.system")) {
            mThemeSwitch.setValue("8");
        } else if (BeneditionUtils.isThemeEnabled("com.android.theme.darkgrey.system")) {
            mThemeSwitch.setValue("7");
        } else if (BeneditionUtils.isThemeEnabled("com.android.theme.pitchblack.system")) {
            mThemeSwitch.setValue("6");
        } else if (BeneditionUtils.isThemeEnabled("com.android.theme.chocox.system")) {
            mThemeSwitch.setValue("5");
        } else if (BeneditionUtils.isThemeEnabled("com.android.theme.bakedgreen.system")) {
            mThemeSwitch.setValue("4");
        } else if (BeneditionUtils.isThemeEnabled("com.android.theme.solarizeddark.system")) {
